...
// Vite 下用 import.meta.glob 收集页面模块（构建期展开为动态 import，等价 webpack 的动态 import 写法）
const viewModules = import.meta.glob('../views/**/*.vue');
const loadingLazy = (view) => viewModules[`../views/${view}.vue`];
...
// ---------- Vue 特性 ----------
{
  ...
  component: loadingLazy('vue/Communication'),
  meta: { name: '组件通信八式', group: 'Vue 特性' }
}, {
  path: '/vue/slots',
  name: 'VueSlots',
  component: loadingLazy('vue/Slots'),
  meta: { name: '插槽三种用法', group: 'Vue 特性' }
}, {
  path: '/vue/directive',
  name: 'VueDirective',
  component: loadingLazy('vue/Directive'),
  meta: { name: '自定义指令', group: 'Vue 特性' }
}, {
  path: '/vue/mixin',
  name: 'VueMixin',
  component: loadingLazy('vue/Mixin'),
...
// ---------- 组件库对比 ----------
{
  path: '/ui/compare',
  name: 'UiCompare',
  component: loadingLazy('ui/Compare'),
  meta: { name: '双库总览对比', group: '组件库对比' }
}, {
  path: '/ui/element-form',
  name: 'ElementForm',
  component: loadingLazy('ui/ElementForm'),
  meta: { name: 'Element 表单', group: '组件库对比' }
}, {
  path: '/ui/element-table',
  name: 'ElementTable',
  component: loadingLazy('ui/ElementTable'),
  meta: { name: 'Element 表格', group: '组件库对比' }
}, {
  path: '/ui/antd-form',
  name: 'AntdForm',
  component: loadingLazy('ui/AntdForm'),
  meta: { name: 'Antd 表单', group: '组件库对比' }
}, {
  path: '/ui/antd-table',
  name: 'AntdTable',
  component: loadingLazy('ui/AntdTable'),
...
// ---------- 路由方案 ----------
{
  ...
  name: 'RouterParams',
  component: loadingLazy('router/Params'),
  meta: { name: '动态路由参数', group: '路由方案', link: '/router/params/42' }
}, {
  path: '/router/guard',
  name: 'RouterGuard',
  component: loadingLazy('router/Guard'),
...
// ---------- Vuex ----------
{
  path: '/vuex/counter',
  name: 'VuexCounter',
  component: loadingLazy('vuex/Counter'),
...
// ---------- 样式方案 ----------
{
  path: '/style/less',
  name: 'StyleLess',
  component: loadingLazy('style/Less'),
...
// ---------- 工程化 ----------
{
  ...
  name: 'AutoRegister',
  component: loadingLazy('engineering/AutoRegister'),
...
// ---------- 网络通信 ----------
{
  ...
  name: 'WebsocketBasic',
  component: loadingLazy('websocket/Websocket'),
  meta: { name: 'WebSocket 基础', group: '网络通信' }
}, {
  path: '/websocket/heartbeat',
  name: 'WebsocketHeartbeat',
  component: loadingLazy('websocket/Heartbeat'),
...
// ---------- 二维码 ----------
{
  ...
  name: 'QrcodeGenerate',
  component: loadingLazy('qrcode/Qrcode'),
