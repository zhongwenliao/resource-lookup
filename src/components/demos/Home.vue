...
npm run lint</code></pre>
    ...
    <demo-block
      ...
      <pre class="quick-start"><code>1. 在 src/components/demos/ 下新建 .vue 演示页
2. 在 src/router.js 的 routeConfig 中注册一条路由
...
export default {
  ...
  data () {
    return {
      stackTags: ['Vue 2.6', 'Vue Router 3', 'Vuex 3', 'Element UI 2.x', 'Ant Design Vue 1.x', 'Less 3', 'webpack 3', 'ESLint + Prettier'],
      modules: [{
        ...
        title: '工程化',
        desc: 'require.context 自动注册、webpack 配置要点'
      }]
    };
  }
};
