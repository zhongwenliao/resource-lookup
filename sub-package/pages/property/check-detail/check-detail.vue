	...
	<view class="content check-detail-content">
		<form @submit="submit" style="margin-top: 10upx; padding-left: 30upx; padding-right: 30upx;">
			...
			<view class="form-item" style="">
				...
				<!-- <image src="https://file.yuanzhoulvwego.com/prod/uploadFiles/img/1.jpg" mode="aspectFit" style="width: 300upx;"></image> -->
				<view style="display: flex; justify-content: flex-start;">
					<image src="https://file.yuanzhoulvwego.com/prod/uploadFiles/img/1.jpg" mode="widthFix" style="width: 200upx;"></image>
				</view>
			</view>
			<!-- 小区地址 end -->
