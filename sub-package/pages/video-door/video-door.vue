<template>
	<uni-base-page class="content">
		<view class="search-input">
			<image src="../../../sub-package/static/img/search.png" alt="">
				...
				<li v-for="doorObj in videoDoorList" :key="doorObj.doorId">
					...
					<view class="btn">
						...
						<button @click="videoCall(doorObj)">
							<image src="../../../sub-package/static/img/video/video.png" />
						</button>
						<!-- 呼叫设备展示区 end -->
						...
						<button @click="openDoor(doorObj)">
							<image src="../../../sub-package/static/img/video/door.png" />
						</button>
						<!-- 远程开门展示区 end -->
						
						<!-- 查看设备详情展示区 start -->
						<button @click="checkInfo(doorObj)">
							<image src="../../../sub-package/static/img/video/info.png" />
						</button>
						<!-- 查看设备详情展示区 end -->
