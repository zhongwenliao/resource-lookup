...
export default {
  ...
  onLoad: function (options) {
    ...
    this.enterRoom({
	  ...
	  // 下面两个参数用于设备远程开门
	  devSn: options.devSn,
	  relayIndex: options.relayIndex || 1
    });
  },
  ...
  methods: {
    ...
    enterRoom: function (params) {
	  ...
	  params.sdkAppID = params.sdkAppID || Signature.sdkAppID;
	  params.userSig = params.userSig || Signature.userSig;
      ...
      if (params.template === 'grid') {
        this.rtcConfig = {
		  ...
		  devSn: params.devSn || "",
		  relayIndex: params.relayIndex || 1
        };
      } else {
        this.rtcConfig = {
          sdkAppID: params.sdkAppID,
