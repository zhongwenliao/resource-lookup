						...
						<ul>
							<li class="clear" v-for="(item, index) in discountList" :key="item.id">
								<view class="dis-left fl">
									...
									<view class="money" v-else><image class="opacity" src="https://file.yuanzhoulvwego.com/prod/uploadFiles/img/free.png"></image></view>
								...
								<image v-if="item.isInvaild == 1" class="lose-img" src="https://file.yuanzhoulvwego.com/prod/uploadFiles/img/lose.png"></image>
								<image v-if="item.isUse == 1" class="used-img" src="https://file.yuanzhoulvwego.com/prod/uploadFiles/img/uesd.png"></image>
							</li>
						</ul>
					</scroll-view>
				</swiper-item>
