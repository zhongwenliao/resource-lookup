...
<script>
	...
	let devObj = {};
	let gender = 0, faceCaptureImageBase64 = "", certNo = "", name = "", phone = "", devKey = "", devSn = "", accStartdatetime = "", 
	...
	export default {
		...
		onLoad(options) {
			...
			this.userInfo.certNoEncode = options.certNoEncode;
			this.$showLog("id", this.userInfo.id);
			this.$showLog("certNoEncode", this.userInfo.certNoEncode);
