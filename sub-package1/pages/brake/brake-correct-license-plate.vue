						...
						<view class="search-result__park-record__title">
							<view class="park-record__title__car-no-similarity">
								...
								<view class="park-record__title__car-no-similarity__container">
									<image src="https://file.yuanzhoulvwego.com/prod/uploadFiles/img/parking-assistant/shi.png" mode="aspectFit" />
	...
	export default {
		...
		methods: {
			...
			loadParkRecordImgError(type, parkRecord) {
				// 进场图片
				if (type == 1) {
					parkRecord.inImg = "https://file.yuanzhoulvwego.com/prod/uploadFiles/img/parking-assistant/che.png";
				}
				// 出场图片
				else {
					parkRecord.outImg = "https://file.yuanzhoulvwego.com/prod/uploadFiles/img/parking-assistant/che.png";
				}
			},
