<template>
  <view class="register_page">
    ...
    <view class="btn_box">
      <view class="">
        <u-button :custom-style="customStyle" class="u-m-b-20" shape="circle" @click="onSubmit" type="primary"
          >登录
        </u-button>
      </view>
      <view class="" style="margin-top: 20upx">
        <u-button :custom-style="customStyle2" shape="circle" @click="onPageJump('/pages/login/register')"
          >注册
        </u-button>
      </view>
    </view>
