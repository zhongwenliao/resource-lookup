<template>
	<view class="page">
		<u-navbar class="navbar" title="注册" :border-bottom="false">
		</u-navbar>
		...
		<u-form :border-bottom="false" label-width="190" style="padding: 70upx 20px 0upx 20px;" :model="form"
			...
			<view class="form-item_box">
				...
				<u-form-item class="form-item" prop="name" :border-bottom="true" label=" ">
					<u-input placeholder-style="color:#999999;" :custom-style="fieldStyle" placeholder="请输入姓名"
						v-model="form.name">
					</u-input>
				</u-form-item>
			</view>
