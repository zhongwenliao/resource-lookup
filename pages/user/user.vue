      ...
      <view class="user-top u-flex">
        <view @click="goUserInfo" class="u-flex u-m-l-50" style="margin-top: -50rpx">
          ...
          <view class="u-m-l-10 u-flex-col u-row-around u-text-color-fff" style="height: 60px">
            ...
            <view class="u-font-md"> 所属公司：{{ userInfo.enterpriseName }} </view>
            <view class="u-font-md"> 账号：{{ userInfo.phone }} </view>
          </view>
        </view>
      </view>
    </view>
...
export default {
  data() {
    return {
      ...
      src: uni.getStorageSync("userInfo")
        ? uni.getStorageSync("userInfo").avatar
        : "https://file.yuanzhoulvwego.com/prod/uploadFiles/user/pic4.png",
      cellTitle: {
        color: "#333333",
        fontSize: "32upx",
        fontWeight: "bold",
