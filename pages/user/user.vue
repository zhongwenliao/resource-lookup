		...
		<view class="head">
			...
			<view class="user-top u-flex">
				<view @click="goUserInfo" class="u-flex u-m-l-50" style="margin-top: -50rpx;">
					<u-avatar :src="src ? src : '/static/morentouxiang.png'" size="110"></u-avatar>
				...
				<u-cell-group class="cell-group" :border="false">
					<u-cell-item @click="goMyInformation" :title-style="cellTitle" v-if="userInfo.enterpriseId">>
						<u-icon margin-left="10" label="  " size="30" slot="icon"
							name="/static/user-grid/wodexiaoxi.png">
						</u-icon>
					...
					<u-cell-item @click="goAboutUs" :title-style="cellTitle">
						<u-icon margin-left="10" label="  " size="30" slot="icon"
							name="/static/user-grid/guanyuwomen.png">
						</u-icon>
						<view slot="title" class="" style="position: relative;">
							关于我们
						</view>
	...
	export default {
		data() {
			return {
				...
				src: uni.getStorageSync('userInfo') ? uni.getStorageSync('userInfo').avatar : '../static/user/pic4.png',
				cellTitle: {
					color: '#333333',
					fontSize: '32upx',
					fontWeight: 'bold',
...
<style lang="scss" scoped>
	...
	.head {
		background: url('/static/user-grid/beijin.png') no-repeat;
