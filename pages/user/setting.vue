<template>
	<view>
		...
		<u-modal v-model="show" @confirm="clearStorage" content="清除缓存!" :show-cancel-button="true" ref="uModal"
			:async-close="true"></u-modal>
		<u-modal v-model="showExitLogin" @confirm="exitLogin" content="是否退出登录!" :show-cancel-button="true" ref="uModal"
			:async-close="true"></u-modal>
		...
		<view class="">
			...
			<u-cell-group class="cell-group cell-group-exitLogin" :border="false">
				<u-cell-item bg-color="#3E76F4" @click="showExitLogin=true" :title-style="exitLoginStyle" :arrow="false">
					<view class="exitLogin" slot="title">
						退出登录
					</view>
				</u-cell-item>
			</u-cell-group>
