        ...
        <view class="right-value" slot="right-value">
          <view @tap.stop="preAvatar" class="">
            <u-image
              ...
              height="88"
              :src="
                userInfo.avatar ? userInfo.avatar : 'https://file.yuanzhoulvwego.com/prod/uploadFiles/morentouxiang.png'
              "></u-image>
          </view>
        </view>
      </u-cell-item>
      <u-cell-item
        :title-style="cellTitle"
        :value-style="cellTitle"
        :arrow="false"
        title="账号"
        :value="userInfo.loginAccount"></u-cell-item>
      <u-cell-item
        :title-style="cellTitle"
        :value-style="cellTitle"
        :arrow="false"
        title="用户名"
        :value="userInfo.userName"></u-cell-item>
      <u-cell-item
        :title-style="cellTitle"
        :value-style="cellTitle"
        :arrow="false"
        title="所属公司"
        :value="userInfo.enterpriseName"></u-cell-item>
      <u-cell-item
        :title-style="cellTitle"
        :value-style="cellTitle"
        :arrow="false"
        title="角色"
        :value="userInfo.roleNames"></u-cell-item>
      <u-cell-item
        :title-style="cellTitle"
        :value-style="cellTitle"
        :arrow="false"
        title="部门"
        :value="userInfo.deptName"></u-cell-item>
      <u-cell-item
        :title-style="cellTitle"
        :value-style="cellTitle"
        :arrow="false"
        title="手机号"
        :value="userInfo.phone"></u-cell-item>
  ...
  methods: {
    ...
    preAvatar() {
      let urls = this.userInfo.avatar
        ...
        : "https://file.yuanzhoulvwego.com/prod/uploadFiles/morentouxiang.png";
      wx.previewImage({
