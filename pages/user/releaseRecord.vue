<template>
  <page>
    ...
    >
      ...
      <view class="content">
        <view class="boxs" v-for="(item, index) in dataList" @click="record(item)">
          <view class="boxs-top">
            ...
            <view
              ...
              :class="
                item.approvalStatus === 0
                  ...
                  ? item.approvalStatus === 1 && item.releaseStatus === 0
                    ? 'bcolor'
                    : item.approvalStatus === 1 && item.releaseStatus === 1
                    ? ''
                    : 'rcolor'
                  : 'rcolor'
              "
