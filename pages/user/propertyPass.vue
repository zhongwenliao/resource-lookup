<template>
  <view class="body">
    <u-navbar :title="'物品放行'">
      <view class="recordobj" style="margin-left: 570upx"> </view>
    </u-navbar>

    <view class="content">
      <view style="float: right; padding-right: 20upx" @click="record">记录</view>
      <u-form :border-bottom="false" label-width="150upx" :model="form" ref="uForm">
        ...
        <view class="form-item_box">
          ...
          <view class="form-item_box_body">
            <u-form-item class="form-item" prop="roomName" :border-bottom="false" label="房间号">
            ...
            <u-form-item class="form-item" prop="movingDate" :border-bottom="false" label="搬运日期">
              <u-input type="select" @click="show = true" placeholder="请选择日期" v-model="form.movingDate" />
            </u-form-item>
          </view>
        </view>
        <!-- 投诉信息 end -->
        <view class="form-item_box">
          ...
          <view>
            <view class="item-box" v-for="(item, index) in form.fwItemReleaseDetails" :key="index">
              ...
              <u-form-item
                style="width: 2upx; margin: 25upx 25upx 0upx 25upx; height: 70upx; background: #999999"
              ></u-form-item>
              <u-form-item label-width="20upx" prop="count" :target="item">
                <u-input
                  ...
                  placeholder="请输入物品数量"
                  type="number"
                  placeholder-style="margin-left:20upx;color:#999999"
                ></u-input>
              </u-form-item>
        ...
        <view class="form-item_box">
          ...
          <view class="form-item_box_body">
            <u-form-item label-position="top" :label-style="labelStyle" :border-bottom="false" label=" ">
              <u-upload
                width="181"
                height="181"
