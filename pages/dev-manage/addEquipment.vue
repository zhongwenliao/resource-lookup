<template>
  ...
  <view style="height: 100%">
    ...
    <view class="content">
      <u-form :border-bottom="false" label-width="190" style="padding: 20upx 20px 0upx 20px" :model="form" ref="uForm">
        <view class="form-item_box">
          <u-form-item required class="form-item" prop="positionTypeName" :border-bottom="false" label="安装位置">
            <u-input
              type="select"
              @click="positionTypeSelect = true"
              placeholder="请选择安装位置"
          ...
          <u-form-item required class="form-item" prop="deviceInstallAddress" :border-bottom="false" label="设备地址">
