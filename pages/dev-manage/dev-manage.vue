				...
				<li v-for="(dev,index) in devList" :key="index" @click="checkInfo(dev)">
					<view class="sub-list">
						...
						<image v-if=" dev.connectionStatus && dev.connectionStatus === 1 "
							:src=" dev.accRelayStatus !== -1? onlineImgList[dev.accRelayStatus] : '../../sub-package1/static/img/manage/dev-manage-green.png'" />
						<image v-else-if=" dev.connectionStatus && dev.connectionStatus === 0 "
							:src=" dev.accRelayStatus !== -1? offlineImgList[dev.accRelayStatus] : '../../sub-package1/static/img/manage/dev-manage.png'" />
						<image v-else src="../../sub-package1/static/img/manage/dev-manage.png" />
						<view class="dev-name">
							<view>
