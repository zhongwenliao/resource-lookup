	...
	<page>
		...
		<!-- <view class="box-erweima">
			<view class="box-erweimaimage">
				<!-- <u-image width="273px" height="403px" src="/static/home/payParking/tingchejiaofei.jpg"></u-image> 
				<text>请扫车场二维码</text>
			</view>
		</view> -->
		<div id="imgBox">
			<u-image id="image" @click="previewImage" width="273px" height="403px" src="/static/home/payParking/tingchejiaofei.jpg"></u-image>
			<p>点击放大，长按可保存</p>
		</div>
		<!-- <view class="box-sao" @click="paymentCar">
			<view class="box-bobo">
				<u-image class="image-box" width="84upx" height="85upx" src="/static/home/payParking/saoyisao.png"></u-image>
