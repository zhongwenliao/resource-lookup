	...
	<page style="width: 100%;" class="page">
		...
		<view class="u-m-20 u-m-t-70 u-p-b-50">
			<view class="card card-img">
				<view class="image">
					<u-image width="110upx" height="110upx" :fade="false" src="/static/home/contract/hetong1.png">
...
<style>
	page {
		/* background: red; */
		background-image: url('/static/home/contract/beijn.png');
		overflow:auto !important;
	}
</style>
<style scoped lang="scss">
	.connector1 {
		background: url('/static/home/billPay/lianjiexian.png') no-repeat;
	...
	.card-img {
		// background-image: url('/static/home/contract/di.png');
