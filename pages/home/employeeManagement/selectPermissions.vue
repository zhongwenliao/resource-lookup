		...
		<view class="u-p-l-20 u-p-r-20 u-p-t-38 u-p-b-38">
				...
				<view class="card-permiss-center u-m-t-45 u-p-b-40 u-flex u-flex-wrap">
					...
					>
						...
						<u-icon
							...
							:name="'../../../static/home/employeeManagement/quxiao.png'"
							size="32"
							@click="delCard(index)"
						></u-icon>
					</view>
			...
			<view class="access-authority u-m-t-54">
				...
				<view class="access-authority-center u-m-t-50 u-m-l-10 u-m-r-10">
					<view class="u-m-b-48">
						<u-icon size="30" :name="'../../../static/home/employeeManagement/yuanqu.png'"></u-icon>
							...
							<view class="u-m-b-54" :class="item.hidden === true ? '' : 'displayNone'">
								<view class="u-flex u-flex-wrap">
									<view
										...
										<u-icon
											:name="citem.checked ? '../../../static/home/employeeManagement/suo-bai.png' : 
											'../../../static/home/employeeManagement/suo.png'"
											size="30"
											class="u-m-r-10"
	...
	.card-permiss {
		...
		.card-permiss-center {
			...
			.card-permiss-center-view {
				...
				padding-right: 22upx;
				margin-bottom: 10upx;
				background-image: url('../../../static/home/employeeManagement/ka.png');
