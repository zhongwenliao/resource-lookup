			...
			<view class="u-m-t-50">
				<u-cell-group :border="false">
					...
					<u-cell-item @click="radioValue='支付宝'" :arrow="false" :title-style="titleStyle" title="支付宝支付">
						<u-icon slot="icon" size="50" name="/static/home/billPay/zhifubao.png"></u-icon>
					...
					<u-cell-item @click="radioValue='微信'" :border-bottom="false" :arrow="false" :title-style="titleStyle" title="微信支付">
						<u-icon slot="icon" size="50" name="/static/home/billPay/weixinzhifu.png"></u-icon>
...
<style lang="scss" scoped>
	...
	.head{
		width: 100%;
		height: 380upx;
		background: url('/static/home/billPay/beijin.png') no-repeat;
