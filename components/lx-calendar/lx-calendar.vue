...
<style lang="less">
@import (less) 'https://file.yuanzhoulvwego.com/prod/uploadFiles/lx-calendar/fonts/iconfont.css';
...
.date_dl{
	...
	.dd{
		...
		.dot{
			...
			position: absolute; bottom: 18upx; left: 50%; transform: translateX(-50%);
		}
	}
}
</style>
