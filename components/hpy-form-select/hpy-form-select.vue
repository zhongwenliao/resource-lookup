		...
		<picker :mode="mode" @change="chagne" :value="selectValue" 
			...
			<block v-else>
				<view class="select-picker" :class="hideBorder?'':'select-picker-border'">
					<text class="placeholder1" :class="selectValue === ''?'default':''">{{selectText}}</text>
...
<style lang="scss" scoped>
	.select-picker {/* #ifndef APP-NVUE */display: flex;/* #endif */flex-direction: row;align-items: center;flex-wrap: nowrap;font-size: 1em;line-height: 38px;overflow: hidden;/* #ifdef APP-NVUE */height: 40px;/* #endif */}
	// .select-picker-border{border: 1px solid #e5e5e5;border-radius: 5px;}
	.is-input-error-border .select-picker-border{border-color: #33bfff}
	...
	.select-picker-arrow{width:7px;height:7px;border-left:1px solid #000;border-bottom:1px solid #000}
	.placeholder1.default{color: grey;text-indent: 0px;}
</style>
