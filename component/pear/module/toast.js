        ...
        if (xpos !== 0) {
          ...
          if (xpos > 0) {
            ...
            if (opacity < opacityRange) {
              instance.hide(
                extend(settings, { transitionOut: "fadeOutRight", transitionOutMobile: "fadeOutRight" }),
                toast,
                "drag"
              );
            }
            ...
            if (opacity < opacityRange) {
              instance.hide(
                extend(settings, { transitionOut: "fadeOutLeft", transitionOutMobile: "fadeOutLeft" }),
                toast,
                "drag"
              );
            }
  ...
  $iziToast.show = function(options) {
    ...
    if (settings.displayMode === 1 || settings.displayMode == "once") {
      try {
        ...
        console.warn(
          "[" + PLUGIN_NAME + "] Could not find an element with this selector: " + "#" + settings.id + ". Try to set an valid id."
        );
      }
    }
