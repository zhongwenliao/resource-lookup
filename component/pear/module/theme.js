layui.define(["jquery", "layer"], function(exports) {
  ...
  theme.colorSet = function(color, second) {
    ...
    style +=
      ...
      " 3px solid!important;}";
    style +=
      ".layui-nav .layui-nav-child dd.layui-this a, .layui-nav-child dd.layui-this{background-color:" + color + ";color:white;}";
    ...
    style +=
      ".layui-input:focus,.layui-textarea:focus {border-color: " +
      color +
    ...
    style +=
      ".layui-tab-brief>.layui-tab-more li.layui-this:after, .layui-tab-brief>.layui-tab-title .layui-this:after{border-bottom: 3px solid " +
      color +
      "!important}";
    ...
    style +=
      "div[xm-select-skin=normal] .xm-select-title div.xm-select-label>span{border: 1px solid " +
      color +
    ...
    style +=
      "div[xm-select-skin=normal].xm-form-selected .xm-select, div[xm-select-skin=normal].xm-form-selected .xm-select:hover{border-color:" +
      color +
      "!important}";
    ...
    style +=
      ".light-theme .pear-nav-tree .layui-this a:hover,.light-theme .pear-nav-tree .layui-this,.light-theme .pear-nav-tree .layui-this a {background-color:" +
      second +
      "!important;color:" +
      color +
      "!important;}";
    ...
    if (this.autoHead === true || this.autoHead === "true") {
      style +=
        ".pear-admin.banner-layout .layui-header .layui-logo,.pear-admin .layui-header{border:none;background-color:" +
        color +
        "!important;}.pear-admin.banner-layout .layui-header .layui-logo .title,.pear-admin .layui-header .layui-nav .layui-nav-item>a{color:whitesmoke!important;}";
      style += ".pear-admin.banner-layout .layui-header{ box-shadow: 2px 0 6px rgb(0 21 41 / 35%) }";
      style +=
        ".pear-admin .layui-header .layui-layout-control .layui-this *,.pear-admin.banner-layout .layui-header .layui-layout-control .layui-this *{ background-color: rgba(0,0,0,.1)!important;}";
    }
