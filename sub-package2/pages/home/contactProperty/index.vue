	...
	<view class="box4">
		...
		<view>
			...
			<u-mask :show="show" @click="show = false" :mask-click-able='false'>
				<view class="warp">
					<!-- <u-image src="https://file.yuanzhoulvwego.com/prod/uploadFiles/hujiao.png"></u-image> -->
					
					<view class="rect" @click="call">
						<view class="rect-t">
							<u-image class="rect2" style="margin-right: 20upx;" width="44rpx" height="44rpx" src="https://file.yuanzhoulvwego.com/prod/uploadFiles/hujiao.png"></u-image>
