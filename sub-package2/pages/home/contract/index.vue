      ...
      <view class="">
          ...
          <view v-for="(item, index) in contractList" class="card" @click="goContractInfo(item)">
            <view class="head">
              <view class="head-left">
                <u-icon
                  class="u-m-r-10"
                  name="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/contract/hetong.png"
                  size="30"
                ></u-icon>
                合同编号{{ item.contractCode }}
              </view>
              <view v-if="item.contractStatus < 2" class="head-right" style="color: #3e76f4"> 进行中 </view>
              <view v-else class="head-right" style="color: #666666"> 已过期 </view>
            </view>
            <view class="body">
              <view class="body-text body-but-box">
                <view class="u-m-b-10 u-flex-row">
                  <view class="u-m-r-10"> 租用地址: </view>
                ...
                <view class="u-m-b-10"> 租用企业: {{ item.enterpriseInfo.companyName }} </view>
                <view class="u-m-b-10"> 租赁单价: {{ item.enterpriseInfo.rentMonth }}元/m2 </view>
                <view class="u-m-b-10"> 合同期限: {{ item.contractDate }} - {{ item.expiryDate }} </view>
              </view>
            </view>
          </view>
        </block>
        <view v-else class="u-m-t-150 u-text-center u-font-sm">
          <u-image
            width="100%"
            height="300rpx"
            src="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/contract/zanwuhetong.png"
          ></u-image>
...
.top-top {
  height: 343upx;
  background-image: url("https://file.yuanzhoulvwego.com/prod/uploadFiles/home/contract/chahua.png");
