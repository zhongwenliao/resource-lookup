  ...
  <page style="width: 100%" class="page">
    ...
    <view class="u-m-20 u-m-t-70 u-p-b-50">
      <view class="card card-img">
        <view class="image">
          <u-image
            ...
            height="110upx"
            :fade="false"
            src="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/contract/hetong1.png"
          >
        ...
        <view class="head">
          <view class="head-left"> 合同信息 </view>
          <view class="head-right"> </view>
        </view>
        <view class="body">
          <view class="body-text body-but-box">
            <view class="u-m-b-10 u-flex u-row-between">
              <view class=""> 合同状态 </view>
              <view
                class=""
                :style="{
                  color:
                    contractInfo.contractStatus != undefined ? contractStatus[contractInfo.contractStatus].color : '',
                }"
              >
            ...
            <view class="u-m-b-10 u-flex u-row-between">
              <view class=""> 合同年限 </view>
              <view class=""> {{ contractInfo.contractExpiry }}年 </view>
            </view>
          </view>
        </view>
      </view>
      <view class="card card-bg">
        ...
        <view class="connector2"></view>
        <view class="head">
          <view class="head-left"> 我的信息 </view>
          <view class="head-right">
            <u-icon
              @click="goCustomerInfo"
              name="arrow-right"
              label-pos="left"
              label-size="28"
              label-color="#333333"
        ...
        <view class="body">
          <view class="body-text body-but-box">
            ...
            <view class="u-m-b-10 u-flex u-row-between">
              ...
              <view class="">
                {{
                  industryList[contractInfo.enterpriseInfo.industryId - 1]
                    ? industryList[contractInfo.enterpriseInfo.industryId - 1].name
                    : ""
                }}
              </view>
            </view>
            <view class="u-m-b-10 u-flex u-row-between">
              <view class=""> 企业法人 </view>
              <view class="">
      ...
      <view class="card card-bg">
        <view class="head">
          <view class="head-left"> 租金信息 </view>
          <view class="head-right">
            <u-icon
              @click="goCustomerInfo2"
              name="arrow-right"
              label-pos="left"
              label-size="28"
              label-color="#333333"
        ...
        <view class="body">
          <view class="body-text body-but-box">
            ...
            <view class="u-m-b-10 u-flex u-row-between">
              <view class=""> 月管理费 </view>
              <view class=""> {{ contractInfo.propertyCosts }}元 </view>
            </view>
            <view class="u-m-b-10 u-flex u-row-between">
              <view class=""> 押金 </view>
              <view class=""> {{ contractInfo.deposit }}元 </view>
            </view>
            <view class="u-m-b-10 u-flex u-row-between">
              <view class=""> 签约时间 </view>
              <view class="">
                {{ contractInfo.contractDate }}
              </view>
            </view>
            <view class="u-m-b-10 u-flex u-row-between">
              <view class=""> 到期时间 </view>
              <view class="">
...
.card {
  ...
  .image {
    ...
    width: 130upx;
    height: 130upx;
	background-image: url('https://file.yuanzhoulvwego.com/prod/uploadFiles/home/contract/hetong1.png');
	background-size: 100% 100%;
  	background-repeat: no-repeat;
    .u-image {
      left: 50%;
