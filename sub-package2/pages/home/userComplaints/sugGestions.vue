      ...
      <u-form :border-bottom="false" label-width="150upx" :model="form" ref="uForm">
        ...
        <view class="form-item_box">
          ...
          <view class="form-item_box_body">
            ...
            <u-form-item class="form-item" prop="phone" :border-bottom="false" label="联系电话">
              <u-input placeholder="请输入联系电话" v-model="form.phone" />
            </u-form-item>
            <u-form-item required class="form-item" prop="classificationName" :border-bottom="false" label="反馈类型">
              <u-input
                type="select"
        ...
        <view class="form-item_box">
          ...
          <view class="form-item_box_body">
            <u-form-item label-position="top" :border-bottom="false" label=" ">
              <my-textarea
                :value.sync="form.repairDescription"
                :maxlength="100"
                :placeholder="'请输入反馈问题'"
              ></my-textarea>
            </u-form-item>
