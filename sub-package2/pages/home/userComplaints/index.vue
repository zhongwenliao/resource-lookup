  ...
  <page class="body">
        ...
        <view class="boxs" v-for="(item, index) in dataList" @click="goRepairProgress(item)">
          <view class="boxs-top">
            <view class="boxs-top-image">
              <u-image
                width="30upx"
                height="30upx"
                src="https://file.yuanzhoulvwego.com/prod/uploadFiles/userComplaints/weixiu.png"
              ></u-image>
            </view>
          ...
          <view class="boxs-center">
            ...
            <view class="boxs-center-right" :class="item.processingStatus !== 4 ? 'bules' : 'grays'">
              {{
                item.processingStatus === 0 || item.processingStatus === 1
                  ? "待处理"
                  : item.processingStatus === 4
                  ? "已完成"
                  : "处理中"
              }}
            </view>
    ...
    <view class="fixed" @click="goRepairApplication" v-if="$permission(['zoneComplaint:addZoneComplaint'])">
      <u-image
        width="158upx"
        height="164upx"
        src="https://file.yuanzhoulvwego.com/prod/uploadFiles/userComplaints/tousujianyi.png"
      ></u-image>
    </view>
    <!-- <view class="dianhua">
...
export default {
  data() {
    return {
      ...
      topBackground: {
        backgroundImage:
          "url(" + "https://file.yuanzhoulvwego.com/prod/uploadFiles/userComplaints/toushuxinxi1.png" + ")",
  ...
  methods: {
    ...
    getInfo(pageNo, pageSize) {
      ...
      that
        .$api("userComplaints.getComplaintsList", params)
        .then((res) => {
          if (res.code == 200) {
...
.body {
  .tops {
    height: 340upx;
    background-image: url("https://file.yuanzhoulvwego.com/prod/uploadFiles/userComplaints/toushuxinxi1.png");
  ...
  .fixed {
    ...
    right: 44upx;
    bottom: 172upx;
    background-image: url("https://file.yuanzhoulvwego.com/prod/uploadFiles/userComplaints/tousujianyi.png");
    background-size: 100% 100%;
    background-repeat: no-repeat;
    width: 158upx;
    height: 164upx;
