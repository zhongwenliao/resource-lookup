      ...
      >
        <view class="form-item_box">
          ...
          <u-form-item required class="form-item" prop="phone" :border-bottom="false" label="手机号码">
            <u-input type="number" placeholder="请输入手机号码" maxlength="11" v-model="form.phone" />
          </u-form-item>
          <u-form-item required class="form-item" prop="genderName" :border-bottom="false" label="性别">
            <u-input type="select" @click="genderSelect = true" placeholder="请选择性别" v-model="form.genderName" />
          </u-form-item>
          <u-form-item required class="form-item" prop="roleName" :border-bottom="false" label="所属部门">
            <u-input
              type="select"
              @click="departmentSelect = true"
              placeholder="请选择所属部门"
              v-model="form.roleName"
            />
          </u-form-item>
          <u-form-item required class="form-item" prop="personnelAccess" :border-bottom="false" label="人员权限">
            <u-input @click="toPersonnelAccess" placeholder="请选择人员权限" v-model="form.personnelAccess" />
            <u-icon slot="right" name="arrow-right"></u-icon>
          </u-form-item>
          <u-form-item required class="form-item" prop="accStartDateTime" :border-bottom="false" label="权限时间">
            <u-input
              type="select"
...
export default {
  ...
  methods: {
    // 部门列表
    getDepartmentAll() {
      this.$api("employeeManagement.getDepartmentAll", { enterpriseId: this.enterpriseId }).then((res) => {
        if (res.code == 200) {
