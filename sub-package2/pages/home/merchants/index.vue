      ...
      <view slot="top" class="">
        ...
        <u-dropdown
          ...
          <u-dropdown-item title="更多">
            <scroll-view scroll-y scroll-with-animation style="height: 700upx" class="u-tab-view menu-scroll-view">
  ...
  methods: {
    ...
    confirmDropdown(type) {
      ...
      if (
        ...
        !(!formDropdown.rentMonthSearch.rentMonthL && !formDropdown.rentMonthSearch.rentMonthH)
      ) {
