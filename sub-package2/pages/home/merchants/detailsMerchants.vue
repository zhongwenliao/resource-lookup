    ...
    <view class="body" style="padding-bottom: 100upx">
      <view class="head_box">
        ...
        <view class="head_box_data">
          <u-row gutter="12">
            <u-col span="4">
              <view class="data_box">
                <view class="data_box_top u-line-1"> {{ merchantsInfo.area || "0" }}m² </view>
                <view class="data_box_bottom"> 总面积 </view>
              </view>
            </u-col>
            <u-col span="4">
              <view class="data_box border">
                <view class="data_box_top u-line-1"> {{ merchantsInfo.rentMonth || 0 }}元 </view>
                <view class="data_box_bottom"> 月租金 </view>
              </view>
            </u-col>
            <u-col span="4">
              <view class="data_box">
      ...
      <view class="info">
        ...
        <view class="info_foot">
          <u-row gutter="12">
            <u-col span="12">
              <text class="info_foot_left"> 房间号 </text>
              <text class="info_foot_right">
                {{ merchantsInfo.buildName + "/" + merchantsInfo.floorName + "/" + merchantsInfo.roomName }}
              </text>
            </u-col>
            <u-col span="6">
              <text class="info_foot_left"> 房间类型 </text>
              <text class="info_foot_right">
                {{ enumFilter($enum.roomType, merchantsInfo.roomType).label }}
              </text>
            </u-col>
            <u-col span="6">
              <text class="info_foot_left"> 月租金 </text>
              <text class="info_foot_right"> {{ merchantsInfo.rentMonth || 0 }}元/月 </text>
            </u-col>
            <u-col span="6">
              <text class="info_foot_left"> 房间面积 </text>
              <text class="info_foot_right"> {{ merchantsInfo.area || 0 }}m² </text>
            </u-col>
            <u-col span="6">
              <text class="info_foot_left"> 管理费 </text>
              <text class="info_foot_right"> {{ merchantsInfo.propertyCosts || 0 }}元/月 </text>
            </u-col>
          </u-row>
        </view>
      </view>
      ...
      <view class="recommended">
        ...
        <view class="richText">
          <view class="u-m-b-20" v-for="(item, index) in recommendedList" :key="index" @click="goDetails(item)">
      ...
      <view class="but_box u-flex u-row-between">
        <view class="u-m-l-60 u-flex">
          <u-icon
            @click="$u.throttle(collection, 1000)"
            label="收藏"
            label-color="#333333"
            label-size="22"
            label-pos="bottom"
          ...
          <button class="share-btn" plain data-name="shareBtn" open-type="share">
            <u-icon
              ...
              width="44"
              height="39"
              name="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/merchants/zhuangfa.png"
            ></u-icon>
          </button>
        </view>
        <view class="right-but_box" @click="intentionApply"> 意向申请 </view>
      </view>
    </view>
  </page>
</template>
...
export default {
  data() {
    return {
      zoneId: "",
      shoucang: "https://file.yuanzhoulvwego.com/prod/uploadFiles/home/merchants/shoucang.png",
      yishoucang: "https://file.yuanzhoulvwego.com/prod/uploadFiles/home/merchants/yishoucang.png",
      title: "招商详情",
      merchantsInfo: {
        collection: 0, //收藏状态
        zone: {},
  ...
  methods: {
    ...
    handleShare() {
      console.log("有触发")
      // uni.mpShare = {
      //   title: "招商详情", // 默认为小程序名称，可自定义
      //   path: "sub-package2/pages/home/merchants/detailsMerchants", // 默认为当前页面路径，一般无需修改，QQ小程序不支持
