...
<script>
	export default {
		...
		onLoad() {
			...
			if(this.results){
				this.title = '支付成功'
				this.resultsImage = 'https://file.yuanzhoulvwego.com/prod/uploadFiles/home/billPay/zhifuichenggong.png'
			}else{
				this.title = '支付失败'
				this.resultsImage = 'https://file.yuanzhoulvwego.com/prod/uploadFiles/home/billPay/zhifuishibai.png'
			}
		}
	}
</script>
