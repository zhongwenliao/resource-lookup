  ...
  <page class="body">
          ...
          <view class="boxs-top">
            <view class="boxs-top-image">
              <u-image
                width="30upx"
                height="30upx"
                src="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/weixiu.png"
              ></u-image>
            </view>
    ...
    <view class="fixed" @click="goRepairApplication" v-if="$permission(['zoneRepair:addZoneRepair'])">
      <u-image
        width="158upx"
        height="164upx"
        src="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/baoxiu.png"
      ></u-image>
    </view>
  </page>
</template>
...
export default {
  data() {
    return {
      ...
      // 导航栏的背景图
      topBackground: {
        backgroundImage: "url(" + "https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/chahua.png" + ")",
  ...
  methods: {
    getInfo(pageNo, pageSize) {
      ...
      that
        .$api("repairs.getMaintenanceInfoList", params)
        .then((res) => {
          if (res.code == 200) {
...
.body {
  .tops {
    height: 340upx;
    background-image: url("https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/chahua.png");
  ...
  .fixed {
    ...
    right: 44upx;
    bottom: 172upx;
    background-image: url("https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/baoxiu.png");
    background-size: 100% 100%;
    background-repeat: no-repeat;
    width: 158upx;
    height: 164upx;
