<template>
	<page class="body">
				...
				<view class="boxs" v-for="(item, index) in dataList" @click="goRepairProgress(item.id)">
					<view class="boxs-top">
						<view class="boxs-top-image" >
							<u-image width="30upx" height="30upx" src="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/weixiu.png"></u-image>
						</view>
		...
		<view class="fixed" @click="goRepairApplication" v-if="$permission(['zoneRepair:addZoneRepair'])">
			<u-image width="158upx" height="164upx" src="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/baoxiu.png"></u-image>
		</view>
	</page>
</template>
