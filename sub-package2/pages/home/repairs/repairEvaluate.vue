<template>
  <view class="body">
    ...
    <view v-if="!evaluationStatus">
      ...
      <view class="btn_box">
        <u-button class="btn_box_button" @click="onSubmit" type="primary" shape="circle"> 提交评价 </u-button>
      </view>
    </view>
    <view v-else>
        ...
        <view class="evaluate-title-top">
          <view class="evaluate-title-top-left">
            <u-image
              ...
              height="54upx"
              :fade="false"
              src="https://file.yuanzhoulvwego.com/prod/uploadFiles/home/repairs/pingjiachenggong.png"
            >
      ...
      <view class="tbtn_box">
        <u-button class="tbtn_box_button" @click="goBefore" type="primary" shape="circle"> 确定 </u-button>
      </view>
    </view>
  </view>
</template>
