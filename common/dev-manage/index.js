...
_this.$objectAssign = function (object1, object2) {
  for (let key in object1) {
    if (
      (this.$isObject(object1[key]) && this.$isObject(object2[key])) ||
      (this.$isArray(object1[key]) && this.$isArray(object2[key]))
    ) {
      object1[key] = {
        ...object1[key],
        ...object2[key],
...
systemInfo.terminalDeviceVersion =
  system.indexOf("android") > -1 || system.indexOf("ios") > -1 ? system : platform + " " + system
